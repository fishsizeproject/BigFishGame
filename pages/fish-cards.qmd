...
::: text-center
*These are all the fish cards included in the standard BigFish game. You can also explore the science behind the [wildcards](../pages/wildcards.qmd) and [round-end cards](../pages/round-end-cards.qmd), or learn the [game rules](../pages/rules.qmd) pages.*
:::
